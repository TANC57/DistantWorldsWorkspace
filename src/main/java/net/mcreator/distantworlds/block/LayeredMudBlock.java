...
import net.mcreator.distantworlds.procedures.LayeredMudUpdateTickProcedure;
...
public class LayeredMudBlock extends Block implements BonemealableBlock {
	public LayeredMudBlock() {
	...
	public void tick(BlockState blockstate, ServerLevel world, BlockPos pos, RandomSource random) {
		...
		int y = pos.getY();
		int z = pos.getZ();
		LayeredMudUpdateTickProcedure.execute(world, x, y, z);
	}
