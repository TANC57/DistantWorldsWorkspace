...
public class UlbiseafBlock extends FlowerBlock implements BonemealableBlock {
	public UlbiseafBlock() {
		super(() -> MobEffects.MOVEMENT_SPEED, 50,
				BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_LIGHT_BLUE).sound(SoundType.GRASS).instabreak().lightLevel(s -> 10).noCollission().offsetType(BlockBehaviour.OffsetType.XZ).pushReaction(PushReaction.DESTROY));
	}
