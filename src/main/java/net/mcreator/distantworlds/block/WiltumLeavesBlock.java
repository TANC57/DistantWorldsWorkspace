...
public class WiltumLeavesBlock extends LeavesBlock implements BonemealableBlock {
	public WiltumLeavesBlock() {
		super(BlockBehaviour.Properties.of().ignitedByLava().mapColor(MapColor.COLOR_CYAN).sound(SoundType.AZALEA_LEAVES).strength(0.2f).noOcclusion());
	}
