...
public class OtreboreBlock extends FlowerBlock implements BonemealableBlock {
	public OtreboreBlock() {
		super(() -> MobEffects.MOVEMENT_SPEED, 50,
				BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_PINK).sound(SoundType.FUNGUS).instabreak().lightLevel(s -> 10).noCollission().offsetType(BlockBehaviour.OffsetType.XZ).pushReaction(PushReaction.DESTROY));
	}
