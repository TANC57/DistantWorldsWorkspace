...
public class WiltumFruitBoxBlock extends Block {
	public WiltumFruitBoxBlock() {
		super(BlockBehaviour.Properties.of().ignitedByLava().instrument(NoteBlockInstrument.BASS).mapColor(MapColor.COLOR_LIGHT_BLUE)
				...
				.strength(2.5f, 5f).noOcclusion().isRedstoneConductor((bs, br, bp) -> false));
	}
