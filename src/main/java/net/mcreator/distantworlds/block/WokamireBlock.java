...
public class WokamireBlock extends SugarCaneBlock implements BonemealableBlock {
	public WokamireBlock() {
		super(BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_BROWN).randomTicks().sound(SoundType.BAMBOO).strength(0.2f, 0.5f).lightLevel(s -> 15).noOcclusion().dynamicShape().offsetType(BlockBehaviour.OffsetType.XZ)
	...
	public VoxelShape getShape(BlockState state, BlockGetter world, BlockPos pos, CollisionContext context) {
		...
		return box(7, 0, 7, 9, 16, 9).move(offset.x, offset.y, offset.z);
	}
