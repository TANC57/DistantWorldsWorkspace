...
public class CulafiteMushroomBlock extends FlowerBlock implements BonemealableBlock {
	public CulafiteMushroomBlock() {
		super(() -> MobEffects.MOVEMENT_SPEED, 100,
				BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_RED).sound(SoundType.FUNGUS).strength(0.1f, 0f).lightLevel(s -> 10).noCollission().offsetType(BlockBehaviour.OffsetType.XZ).pushReaction(PushReaction.DESTROY));
	}
