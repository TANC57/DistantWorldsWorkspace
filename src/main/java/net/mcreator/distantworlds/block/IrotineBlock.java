...
public class IrotineBlock extends FlowerBlock implements BonemealableBlock {
	public IrotineBlock() {
		super(() -> MobEffects.MOVEMENT_SPEED, 50,
				BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_PINK).sound(SoundType.GRASS).instabreak().lightLevel(s -> 10).noCollission().offsetType(BlockBehaviour.OffsetType.XZ).pushReaction(PushReaction.DESTROY));
	}
	...
	public boolean mayPlaceOn(BlockState groundState, BlockGetter worldIn, BlockPos pos) {
		return groundState.is(DistantWorldsModBlocks.LAYERED_MUD.get());
	}
