...
public class WitherTotemOverlayReturnYProcedure {
	public static String execute(Entity entity) {
		...
		return (entity.getCapability(DistantWorldsModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new DistantWorldsModVariables.PlayerVariables())).WitherTotemY <= -64
				? "---"
				: new java.text.DecimalFormat("##").format((entity.getCapability(DistantWorldsModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new DistantWorldsModVariables.PlayerVariables())).WitherTotemY);
	}
}
