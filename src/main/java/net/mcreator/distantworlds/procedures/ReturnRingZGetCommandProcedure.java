...
public class ReturnRingZGetCommandProcedure {
		...
		if (entity.hasPermissions(2)) {
			if ((new Object() {
				...
				if (entity instanceof Player _player && !_player.level().isClientSide())
					...
					}.getEntity()).getCapability(DistantWorldsModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new DistantWorldsModVariables.PlayerVariables())).ReturnRingZ))),
