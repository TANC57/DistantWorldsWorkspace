...
public class GarhennaDepletionSetCommandProcedure {
	public static void execute(LevelAccessor world, CommandContext<CommandSourceStack> arguments, Entity entity) {
		...
		if (entity.hasPermissions(2)) {
			if ((new Object() {
				...
				if (DoubleArgumentType.getDouble(arguments, "amount") > (double) ConfigCommonConfiguration.MAX_GARHENNA_DEPLETION.get()) {
					Amount = (double) ConfigCommonConfiguration.MAX_GARHENNA_DEPLETION.get();
				} else {
