...
public class GarsaleTreePlacementProcedureProcedure {
			...
			if (AllowedHigh == 6) {
				...
				if (Mth.nextInt(RandomSource.create(), 1, 2) == 1) {
					...
					if (Mth.nextInt(RandomSource.create(), 1, 5) <= 1) {
						...
						world.setBlock(BlockPos.containing(x, y + 1, z), DistantWorldsModBlocks.GARSALE_LOG.get().defaultBlockState(), 3);
					}
					if (Mth.nextInt(RandomSource.create(), 1, 3) == 1) {
						if (Mth.nextInt(RandomSource.create(), 1, 4) == 1) {
							if (world instanceof ServerLevel _serverworld) {
								StructureTemplate template = _serverworld.getStructureManager().getOrCreate(new ResourceLocation("distant_worlds", "garsale_type1"));
								if (template != null) {
						...
						if (Mth.nextInt(RandomSource.create(), 1, 4) == 1) {
							if (world instanceof ServerLevel _serverworld) {
								StructureTemplate template = _serverworld.getStructureManager().getOrCreate(new ResourceLocation("distant_worlds", "garsale_type3"));
								if (template != null) {
									template.placeInWorld(_serverworld, BlockPos.containing(x - 2, y + 2, z - 2), BlockPos.containing(x - 2, y + 2, z - 2),
											new StructurePlaceSettings().setRotation(Rotation.NONE).setMirror(Mirror.NONE).setIgnoreEntities(false), _serverworld.random, 3);
								}
				...
				if (Mth.nextInt(RandomSource.create(), 1, 3) <= 1) {
					...
					if (Mth.nextInt(RandomSource.create(), 1, 5) <= 1) {
						world.setBlock(BlockPos.containing(x, y + 2, z), DistantWorldsModBlocks.STICKY_GARSALE_LOG.get().defaultBlockState(), 3);
					} else if (Mth.nextInt(RandomSource.create(), 1, 4) <= 1) {
						world.setBlock(BlockPos.containing(x, y + 2, z), DistantWorldsModBlocks.CRACKED_GARSALE_LOG.get().defaultBlockState(), 3);
					} else {
						world.setBlock(BlockPos.containing(x, y + 2, z), DistantWorldsModBlocks.GARSALE_LOG.get().defaultBlockState(), 3);
					}
					if (Mth.nextInt(RandomSource.create(), 1, 3) == 1) {
						if (Mth.nextInt(RandomSource.create(), 1, 4) == 1) {
							if (world instanceof ServerLevel _serverworld) {
