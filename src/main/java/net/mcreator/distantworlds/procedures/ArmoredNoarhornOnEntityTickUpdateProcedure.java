...
public class ArmoredNoarhornOnEntityTickUpdateProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		Entity NearestEntity = null;
		boolean HasPartner = false;
		if ((entity instanceof ArmoredNoarhornEntity _datEntI ? _datEntI.getEntityData().get(ArmoredNoarhornEntity.DATA_Behavior) : 0) == 2 && !entity.isPassenger()) {
			if (entity.isVehicle()) {
		...
		if ((entity instanceof ArmoredNoarhornEntity _datEntI ? _datEntI.getEntityData().get(ArmoredNoarhornEntity.DATA_InLove) : 0) > 0
			...
			if (entity instanceof ArmoredNoarhornEntity _datEntSetI)
				_datEntSetI.getEntityData().set(ArmoredNoarhornEntity.DATA_InLove, (int) ((entity instanceof ArmoredNoarhornEntity _datEntI ? _datEntI.getEntityData().get(ArmoredNoarhornEntity.DATA_InLove) : 0) - 1));
			{
					...
					if (!(entityiterator == entity) && (entityiterator instanceof NoarhornEntity && (entityiterator instanceof NoarhornEntity _datEntI ? _datEntI.getEntityData().get(NoarhornEntity.DATA_InLove) : 0) > 0
						...
						if (!world.isClientSide()) {
							if (Math.random() < 0.0006) {
								...
								if (entity instanceof ArmoredNoarhornEntity _datEntSetI)
									_datEntSetI.getEntityData().set(ArmoredNoarhornEntity.DATA_BabyAge, 1);
								if (entityiterator instanceof ArmoredNoarhornEntity) {
									if (entity instanceof ArmoredNoarhornEntity _datEntSetI)
										_datEntSetI.getEntityData().set(ArmoredNoarhornEntity.DATA_BabyType, 2);
								} else {
									if (entity instanceof ArmoredNoarhornEntity _datEntSetI)
										_datEntSetI.getEntityData().set(ArmoredNoarhornEntity.DATA_BabyType, (int) (Math.random() < 0.3 ? 2 : 1));
								}
								...
								if (!((entity instanceof TamableAnimal _tamEnt ? (Entity) _tamEnt.getOwner() : null) instanceof ServerPlayer _plr54 && _plr54.level() instanceof ServerLevel
										&& _plr54.getAdvancements().getOrStartProgress(_plr54.server.getAdvancements().getAdvancement(new ResourceLocation("minecraft:husbandry/breed_an_animal"))).isDone())) {
								...
								if (!((entityiterator instanceof TamableAnimal _tamEnt ? (Entity) _tamEnt.getOwner() : null) instanceof ServerPlayer _plr57 && _plr57.level() instanceof ServerLevel
										&& _plr57.getAdvancements().getOrStartProgress(_plr57.server.getAdvancements().getAdvancement(new ResourceLocation("minecraft:husbandry/breed_an_animal"))).isDone())) {
									if (entity instanceof ServerPlayer _player) {
										Advancement _adv = _player.server.getAdvancements().getAdvancement(new ResourceLocation("minecraft:husbandry/breed_an_animal"));
										AdvancementProgress _ap = _player.getAdvancements().getOrStartProgress(_adv);
										if (!_ap.isDone()) {
			...
			if (!HasPartner && !((entity instanceof ArmoredNoarhornEntity _datEntI ? _datEntI.getEntityData().get(ArmoredNoarhornEntity.DATA_Behavior) : 0) == 2 && (entity instanceof TamableAnimal _tamEnt ? _tamEnt.isTame() : false))
					&& !entity.isVehicle()) {
				{
					final Vec3 _center = new Vec3(x, y, z);
		...
		} else if ((entity instanceof ArmoredNoarhornEntity _datEntI ? _datEntI.getEntityData().get(ArmoredNoarhornEntity.DATA_InLove) : 0) < 0) {
			if (entity instanceof ArmoredNoarhornEntity _datEntSetI)
				_datEntSetI.getEntityData().set(ArmoredNoarhornEntity.DATA_InLove, (int) ((entity instanceof ArmoredNoarhornEntity _datEntI ? _datEntI.getEntityData().get(ArmoredNoarhornEntity.DATA_InLove) : 0) + 1));
		}
		if ((entity instanceof ArmoredNoarhornEntity _datEntI ? _datEntI.getEntityData().get(ArmoredNoarhornEntity.DATA_BabyAge) : 0) > 0) {
			if ((entity instanceof ArmoredNoarhornEntity _datEntI ? _datEntI.getEntityData().get(ArmoredNoarhornEntity.DATA_BabyAge) : 0) < 3600) {
				if (entity instanceof ArmoredNoarhornEntity _datEntSetI)
					_datEntSetI.getEntityData().set(ArmoredNoarhornEntity.DATA_BabyAge, (int) ((entity instanceof ArmoredNoarhornEntity _datEntI ? _datEntI.getEntityData().get(ArmoredNoarhornEntity.DATA_BabyAge) : 0) + 1));
			} else {
				if (world instanceof ServerLevel _level) {
					...
					if (entityToSpawn != null) {
						...
						if (entityToSpawn instanceof BabyNoarhornEntity _datEntSetI)
							_datEntSetI.getEntityData().set(BabyNoarhornEntity.DATA_BabyType, (int) (entity instanceof ArmoredNoarhornEntity _datEntI ? _datEntI.getEntityData().get(ArmoredNoarhornEntity.DATA_BabyType) : 0));
				...
				if (entity instanceof ArmoredNoarhornEntity _datEntSetI)
					_datEntSetI.getEntityData().set(ArmoredNoarhornEntity.DATA_BabyAge, 0);
				if (entity instanceof ArmoredNoarhornEntity _datEntSetI)
					_datEntSetI.getEntityData().set(ArmoredNoarhornEntity.DATA_BabyType, 0);
				if (entity instanceof ArmoredNoarhornEntity _datEntSetI)
					_datEntSetI.getEntityData().set(ArmoredNoarhornEntity.DATA_InLove, -3600);
			}
		} else if ((entity instanceof ArmoredNoarhornEntity _datEntI ? _datEntI.getEntityData().get(ArmoredNoarhornEntity.DATA_BabyAge) : 0) < 0) {
			if (entity instanceof ArmoredNoarhornEntity _datEntSetI)
				_datEntSetI.getEntityData().set(ArmoredNoarhornEntity.DATA_BabyAge, 0);
		}
	}
