...
public class GarsaleCrateRightclickedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
		if (entity == null)
			return;
		if ((itemstack.getOrCreateTag().getString("Contains")).equals("noarhorn")) {
			if (world instanceof ServerLevel _level) {
				Entity entityToSpawn = DistantWorldsModEntities.BABY_NOARHORN.get().spawn(_level, BlockPos.containing(x, y, z), MobSpawnType.TRIGGERED);
				if (entityToSpawn != null) {
					...
					if (entityToSpawn instanceof TamableAnimal _toTame && entity instanceof Player _owner)
						_toTame.tame(_owner);
					if (!(itemstack.getOrCreateTag().getString("Name")).equals(Component.translatable("entity.distant_worlds.baby_noarhorn").getString())) {
					...
					if (entityToSpawn instanceof BabyNoarhornEntity _datEntSetI)
						_datEntSetI.getEntityData().set(BabyNoarhornEntity.DATA_Behavior, (int) itemstack.getOrCreateTag().getDouble("Behavior"));
					if (entityToSpawn instanceof BabyNoarhornEntity _datEntSetI)
						_datEntSetI.getEntityData().set(BabyNoarhornEntity.DATA_Age, (int) itemstack.getOrCreateTag().getDouble("Age"));
					if (entityToSpawn instanceof BabyNoarhornEntity _datEntSetI)
						_datEntSetI.getEntityData().set(BabyNoarhornEntity.DATA_BabyType, (int) itemstack.getOrCreateTag().getDouble("BabyType"));
					...
					itemstack.removeTagKey("BabyType");
				}
			}
