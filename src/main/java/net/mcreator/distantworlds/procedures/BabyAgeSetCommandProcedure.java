...
public class BabyAgeSetCommandProcedure {
			...
			if ((new Object() {
				...
				if ((new Object() {
					...
					if ((new Object() {
						...
						_datEntSetI.getEntityData().set(NoarhornEntity.DATA_BabyAge, (int) DoubleArgumentType.getDouble(arguments, "age"));
				} else if ((new Object() {
					public Entity getEntity() {
						try {
							return EntityArgument.getEntity(arguments, "target");
					...
					if ((new Object() {
						...
						_datEntSetI.getEntityData().set(ArmoredNoarhornEntity.DATA_BabyAge, (int) DoubleArgumentType.getDouble(arguments, "age"));
				} else {
					if ((new Object() {
						public Entity getEntity() {
							try {
					...
					}.getEntity()) instanceof SalmoranEntity _datEntSetI)
						_datEntSetI.getEntityData().set(SalmoranEntity.DATA_BabyAge, (int) DoubleArgumentType.getDouble(arguments, "age"));
				}
