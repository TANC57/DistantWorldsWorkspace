...
public class LookAroundAdditionalConditionProcedure {
	public static boolean execute(Entity entity) {
		...
		return (entity instanceof TamableAnimal _tamEnt ? _tamEnt.isTame() : false) ? !entity.isVehicle() && Behavior != 2 : (entity instanceof Mob _mobEnt ? (Entity) _mobEnt.getTarget() : null) == null;
	}
}
