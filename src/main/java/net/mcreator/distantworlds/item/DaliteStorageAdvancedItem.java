...
import net.mcreator.distantworlds.procedures.DaliteStorageAdvancedInInventoryTickProcedure;

import java.util.List;

public class DaliteStorageAdvancedItem extends Item implements ICurioItem {
	public DaliteStorageAdvancedItem() {
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		DaliteStorageAdvancedInInventoryTickProcedure.execute(itemstack);
	}
