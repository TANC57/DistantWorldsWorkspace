...
import net.mcreator.distantworlds.procedures.DaliteStorageInitialItemInInventoryTickProcedure;

import java.util.List;

public class DaliteStorageInitialItem extends Item implements ICurioItem {
	public DaliteStorageInitialItem() {
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		DaliteStorageInitialItemInInventoryTickProcedure.execute(itemstack);
	}
