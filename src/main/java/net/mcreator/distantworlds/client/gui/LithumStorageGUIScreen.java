...
public class LithumStorageGUIScreen extends AbstractContainerScreen<LithumStorageGUIMenu> {
	private final static HashMap<String, Object> guistate = LithumStorageGUIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public LithumStorageGUIScreen(LithumStorageGUIMenu container, Inventory inventory, Component text) {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		if (InputImageDisplayConditionProcedure.execute(world, x, y, z)) {
			guiGraphics.blit(new ResourceLocation("distant_worlds:textures/screens/slot_empty_input.png"), this.leftPos + 43, this.topPos + 26, 0, 0, 16, 16, 16, 16);
		}
		if (OutputImageDisplayConditionProcedure.execute(world, x, y, z)) {
			guiGraphics.blit(new ResourceLocation("distant_worlds:textures/screens/slot_empty_output.png"), this.leftPos + 43, this.topPos + 44, 0, 0, 16, 16, 16, 16);
		}
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		...
		int posY = 7;
		guiGraphics.drawCenteredString(Minecraft.getInstance().font, Component.translatable("name.distant_worlds.lithum_storage"), posX, posY, -8756653);
	}
