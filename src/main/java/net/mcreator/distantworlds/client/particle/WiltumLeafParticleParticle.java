...
@OnlyIn(Dist.CLIENT)
public class WiltumLeafParticleParticle extends TextureSheetParticle {
	public static WiltumLeafParticleParticleProvider provider(SpriteSet spriteSet) {
		return new WiltumLeafParticleParticleProvider(spriteSet);
	}

	public static class WiltumLeafParticleParticleProvider implements ParticleProvider<SimpleParticleType> {
		private final SpriteSet spriteSet;

		public WiltumLeafParticleParticleProvider(SpriteSet spriteSet) {
			this.spriteSet = spriteSet;
		}

		public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
			return new WiltumLeafParticleParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
		}
	}
	...
	protected WiltumLeafParticleParticle(ClientLevel world, double x, double y, double z, double vx, double vy, double vz, SpriteSet spriteSet) {
		super(world, x, y, z);
		this.spriteSet = spriteSet;
		this.gravity = 0.15f;
