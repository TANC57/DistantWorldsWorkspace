...
public class CulafiteShroomerCapRenderer implements ICurioRenderer {
	private static final ResourceLocation TEXTURE = new ResourceLocation("distant_worlds", "textures/entities/culafite_shroomer_cap.png");
	private static final ResourceLocation GLOWING = new ResourceLocation("distant_worlds", "textures/entities/culafite_shroomer_glowing.png");
	private final ModelCulafiteShroomerCap model;

	public CulafiteShroomerCapRenderer() {
		this.model = new ModelCulafiteShroomerCap(Minecraft.getInstance().getEntityModels().bakeLayer(DistantWorldsModLayerDefinitions.CULAFITE_SHROOMER_CAP));
	}
